...
survey.sub.pruned <- filter(survey_data_subset,
...
((summary(survey.sub.pruned$education)/length(survey.sub.pruned$education))*100)
...
summary(survey.sub.pruned$worktime)
