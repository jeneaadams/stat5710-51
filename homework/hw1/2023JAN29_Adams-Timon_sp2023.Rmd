...
```{r US census Bureau data: sex, warning=FALSE}
...
```{r US census Bureau data: age, warning=FALSE}
...
```{r US census Bureau data: education, warning=FALSE}
# US census bureau data
...
```{r US census Bureau data: Income, warning=FALSE}
# US census bureau data
...
There were 51.6 million Sirius Radio listeners then. One approach is to estimate the proportion of the Wharton listeners to that of the Sirius listeners, $p$, so that we will come up with an audience size estimate of approximately 51.6 million times $p$. **Using this method, we estimated that the Wharton audience size in January 2014 is between [1,982,330, 3,189,248], specifically 2,585,789**.
