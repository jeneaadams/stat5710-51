...
```{r cleaned data}
survey.sub <- survey_data_subset
# refactor education responses
print(paste("number of surveys:", nrow(survey.sub)))
...
baseball %>%
  ...
  stat_poly_eq(aes(label = paste(after_stat(eq.label),
                                 after_stat(rr.label), sep = "*\", \"*"))) +
  labs(title = "MLB Team's Win Percentage  vs. Payroll", 
       x = "Payroll", 
       y = "Win Percentage") +
  theme_bw() +
  theme(legend.position = "none")
