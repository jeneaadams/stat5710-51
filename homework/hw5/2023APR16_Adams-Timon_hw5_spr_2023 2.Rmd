...
_Yes, below we see extremely significant evidence that ASVAB_PC1 and ASVAB_PC2 affect the Income  and interact with other variables_
...
_4 Nodes_
_Yes, below we see extremely significant evidence of interaction effect of Gender and Educ over Income_
_We predict Michelle will make 21029.71_
...
_The testing error from fit2 always smaller than that from fit1_
...
for (p in 1:50) 
{
  rf <- ranger::ranger(rating~., iq.train.a, mtry = p, num.trees = 200, importance="impurity")
