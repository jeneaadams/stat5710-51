...
We clearly will need testing errors to tune the parameters. In this case they can be mtry or ntree. We will use the notion of OOB to come with testing errors.
