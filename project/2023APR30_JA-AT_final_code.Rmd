...
plot_transport <- ggarrange(transit_score_plot, walk_score_plot, bike_score_plot, ncol = 2, nrow = 2)

annotate_figure(plot_transport, top = text_grob("Walkability, Bikebility, and Utility of Public Transport by Census Tracts", face = "bold", size = 14))
