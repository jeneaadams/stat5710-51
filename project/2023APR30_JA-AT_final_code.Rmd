...
pacman::p_load(sf, readxl, tidyverse, ggplot2, ggpmisc, ggpubr, censusxy,
               ...
               skimr, GGaly, reshape2, glmnet, caret, viridis, pheatmap, tidycensus) 
...
We found that there were strong associations between indicators of income inequality and adverse health outcomes in and closely bordering the footprint of Philadelphia's Black bottom. 
...
final_data %>%
  ...
  labs(title = "Heat Vulnerability Index by COPD Prevalence", 
...
final_data %>%
  ...
  labs(title = "% of High Produce Supply Stores by High Blood Pressure Prevalence", 
