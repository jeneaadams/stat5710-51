...
```{r}
fit.forward.diab = regsubsets(DIABETES_CrudePrev ~., final_data[-1], nvmax = 60, method = "forward")
...
#### COPD 
```{r}
fit.forward.copd = regsubsets(COPD_CrudePrev ~., final_data[-1], nvmax = 60, method = "forward")
...
```{r}
fit.backward.diab = regsubsets(DIABETES_CrudePrev ~., final_data[-1], nvmax = 60, method = "backward")
...
#### COPD 
```{r}
fit.backward.copd = regsubsets(COPD_CrudePrev ~., final_data[-1], nvmax = 60, method = "backward")
